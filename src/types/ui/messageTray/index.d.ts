...
import {
  ...
  NotificationBanner as BaseNotificationBanner,
  NotificationDestroyedReason,
  PrivacyScope,
  Source,
  Urgency,
...
export class NotificationBanner extends BaseNotificationBanner {
  public addAction(label: string, callback: () => void): unknown;
}
